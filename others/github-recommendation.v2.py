...
def create_lsi_model_new(corpus_tfidf, dictionary, total_lsa_topics, similarity_threshold):
    ...
    # similarity_matrix = similarities.MatrixSimilarity(lsi[corpus_tfidf],num_best=5)
...
lsi = create_lsi_model_new(corpus_tfidf, dictionary, TOTAL_LSA_TOPICS, SIMILARITY_THRESHOLD)
